...
export class PlayerMovement extends Component {
  ...
  touchMove(e) {
    ...
    let width_check = new Vec3(
      this.controller.parent.getComponent(UITransform).width / 2 - this.controller.getComponent(UITransform).width / 2,
      this.controller.parent.getComponent(UITransform).height / 2 - this.controller.getComponent(UITransform).width / 2,
      0
    );
