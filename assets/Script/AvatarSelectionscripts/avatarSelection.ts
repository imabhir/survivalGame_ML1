...
export class avatarSelection extends PopupBase {
  @property({ type: Prefab }) avatar: Prefab = null;
  @property({ type: PageView }) pageView: PageView = null;
  @property({ type: Node }) startButton: Node = null;
  @property({ type: Node }) playerAnimation: Node = null;
  ...
  onLoad() {
    ...
    this.photonInstance = photonmanager.Instance.photon_instance;
