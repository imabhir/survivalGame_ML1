System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, UITransform, Vec3, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, PlayerMovement;
    ...
    execute: function () {
      ...
      _export("PlayerMovement", PlayerMovement = (_dec = ccclass("PlayerMovement"), _dec2 = property({
        ...
        touchMove(e) {
          ...
          this.intialPos = this.joyStickBall.parent.getComponent(UITransform).convertToNodeSpaceAR(new Vec3(e.getUILocation().x, e.getUILocation().y, e.getUILocation().z));
          ...
          var angleDeg = angleRad * 180 / Math.PI; // console.log("angle", angleDeg, " rotation ", this.player.rotation);
...
//# sourceMappingURL=0ebb18bdb40c820201de386e23be0680f2d131f8.js.map