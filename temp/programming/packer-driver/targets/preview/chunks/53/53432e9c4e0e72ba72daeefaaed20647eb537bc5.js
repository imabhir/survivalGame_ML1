      ...
      _export("PlayerMovement", PlayerMovement = (_dec = ccclass("PlayerMovement"), _dec2 = property({
        ...
        getDirection(angle) {
          if (angle > -15 && angle < 15) {
            console.log();
          } else if (angle > 15 && angle < 75) {} else if (angle > 75 && angle < 105) {} else if (angle > 105 && angle < 165) {} else if (angle > 165 && angle < 195) {} else if (angle > 195 && angle < 255) {} else if (angle > 255 && angle > 285) {} else {}
        }
...
//# sourceMappingURL=53432e9c4e0e72ba72daeefaaed20647eb537bc5.js.map