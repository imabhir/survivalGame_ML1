    ...
    execute: function () {
      ...
      _export("PlayerMovement", PlayerMovement = (_dec = ccclass("PlayerMovement"), _dec2 = property({
        ...
        touchMove(e) {
          ...
          this.intialPos = this.joyStickBall.getComponent(UITransform).convertToNodeSpaceAR(new Vec3(e.getUILocation().x, e.getUILocation().y, e.getUILocation().z));
...
//# sourceMappingURL=3f9c63e0b889717a34e4fc2468b7eb4125b7cb9a.js.map